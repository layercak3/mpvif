...
/*
 * This file is modified for use as part of mpvif-plugin. The original header is
 * included below.
 *
...
/* custom */
typedef struct I3ipc_event_cursor_warp {
    int   type; /* = I3IPC_EVENT_CURSOR_WARP */
    int   lx;
    int   ly;
...
^~~~~ This is a union! Use type to determine which member is valid. */
    ...
    I3ipc_event_cursor_warp      cursor_warp;
};
...
enum I3ipc_event_type {
    ...
    I3IPC_EVENT_CURSOR_WARP,             /* 8 ^ 1<<31 */
...
enum I3ipc_type_values {
    ...
    I3IPC_TYPE_EVENT_CURSOR_WARP,       /* I3ipc_event_cursor_warp */
...
int i3ipc__socketpath_cmd_try(char** out_path) {
    ...
    if (pid == 0) {
        ...
        char const* argv[] = {"sway", "--get-socketpath", NULL};
        execvp("sway", (char**)argv);
...
static char const* const i3ipc__global_event_type_name[] = {
    ...
    "barconfig_update",
//    "version",
// ^ why is this here? it seems to fuck shit up for the below events
    "binding",
    "shutdown",
    "tick",
    "cursor_warp"
...
static I3ipc_field i3ipc__global_fields[] = {
    ...
    I3IPC__TYPE_BEGIN(I3IPC_TYPE_EVENT_CURSOR_WARP, I3ipc_event_cursor_warp),
    I3IPC__DOFIELD (I3ipc_event_cursor_warp, I3IPC_TYPE_INT, lx),
    I3IPC__DOFIELD (I3ipc_event_cursor_warp, I3IPC_TYPE_INT, ly),
...
int i3ipc__message_type_to_event(int message_type) {
    ...
    case I3IPC_EVENT_CURSOR_WARP:      return I3IPC_TYPE_EVENT_CURSOR_WARP;
    default: return -1;
    }
}
